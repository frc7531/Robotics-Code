...
public class Robot extends TimedRobot {
  ...
  private TalonSRX rightMotor3 = new TalonSRX(5);
  private TalonSRX leftMotor1 = new TalonSRX(0);
  private TalonSRX leftMotor2 = new TalonSRX(1);
  private TalonSRX leftMotor3 = new TalonSRX(2);
  private TalonSRX fieldMotor1 = new TalonSRX(7);
  private TalonSRX fieldMotor2 = new TalonSRX(8);
